...
with sqlite3.connect('database.db') as db:
    ...
    cursor.execute(""" CREATE TABLE IF NOT EXISTS table_of_nf1 (id INTEGER, brend TEXT, model TEXT, year INTEGER, cost INTEGER, fuel TEXT, volume REAL) """)
    cursor.executescript(""" 
    INSERT INTO table_of_nf1(id, brend, model, year, cost, fuel, volume) VALUES('1', 'Mark II','2021','1 799 000', 'гибрид', 4.0);
    ...
    cursor.execute(""" CREATE TABLE IF NOT EXISTS table_of_nf2_1 (id_number INTEGER, discipline TEXT, audience_number INTEGER, teacher TEXT, date TEXT, number_of_students REAL, time TEXT) """)
    cursor.executescript("""
    ...
    INSERT INTO table_of_nf2_1(id_number, discipline, audience_number, teacher, date, number_of_students, time) VALUES('3', 'Физика','322','Саклаков В.М.','20.10.2022', 17.5, '12.40-14.15');
